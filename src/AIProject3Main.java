...
public class AIProject3Main extends PApplet {
	...
	public void setup() {		
		...
		// filePath = getPath("mid/MaryHadALittleLamb.mid"); // use this for UnitTests
	...
	public void showInstructions() {
		...
		fill(225, 75, 105);
		text("Press the spacebar to restart the melody", width/2, height*11/28);
		...
		text("Press e for Project 3: Unit Test 3", width/2, height*24/28);
		fill(240, 75, 90);
		textSize(10);
		text("(currently generated by the Markov Chain)", width/2, height*8/28);
	}
